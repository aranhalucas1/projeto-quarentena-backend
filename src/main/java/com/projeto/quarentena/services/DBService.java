...
public class DBService {
    ...
    public void instantiateDatabaseTest() {
        Produto p1 = new Produto(null, "Computador", 2200.0, "Descricao do computador");
        Produto p2 = new Produto(null, "Maquina de lavar", 1400.0, "Descricao da maquina de lavar");
        Produto p3 = new Produto(null, "Televisão", 3200.0, "Descricao da televisao");
        Produto p4 = new Produto(null, "Churrasqueira", 800.0, "Descricao da churrasqueira");
